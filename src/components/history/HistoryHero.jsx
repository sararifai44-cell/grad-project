...
const HistoryHero = ({ onQuickStart }) => {
  ...
  return (
    <div className="relative w-full h-screen flex items-center bg-[#0d0c0b] overflow-hidden" dir="rtl">
      ...
      {/* تم تغيير items-center إلى items-end لإنزال المحتوى لأسفل */}
      <div className="relative z-20 w-full h-full max-w-7xl mx-auto px-6 md:px-12 flex items-end justify-start pb-32 md:pb-40">
        ...
        >
          ...
          <motion.button 
            ...
            className="group relative px-10 py-3.5 bg-[#1A3C34] border border-[#C4A87C]/40 text-white rounded-full font-bold text-lg overflow-hidden transition-all shadow-xl hover:border-[#C4A87C]"
          >
